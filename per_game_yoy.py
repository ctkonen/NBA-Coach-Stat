...
def scrape_team_statistics(team_abbr):
    url = f"https://www.basketball-reference.com/teams/{team_abbr}/stats_per_game_yr_yr.html"
    ...
    stat_selectors = {
        ...
        'avg_age_yoy': 'td[data-stat="avg_age"]',
        'avg_height_yoy': 'td[data-stat="avg_ht"]',
        'avg_weight_yoy': 'td[data-stat="avg_wt"]',
        'fg_yoy': 'td[data-stat="fg_per_g"]',
        'fga_yoy': 'td[data-stat="fga_per_g"]',
        'fg_pct_yoy': 'td[data-stat="fg_pct"]',
        '3p_yoy': 'td[data-stat="fg3_per_g"]',
        '3pa_yoy': 'td[data-stat="fg3a_per_g"]',
        '3p_pct_yoy': 'td[data-stat="fg3_pct"]',
        '2p_yoy': 'td[data-stat="fg2_per_g"]',
        '2pa_yoy': 'td[data-stat="fg2a_per_g"]',
        '2p_pct_yoy': 'td[data-stat="fg2_pct"]',
        'ft_yoy': 'td[data-stat="ft_per_g"]',
        'fta_yoy': 'td[data-stat="fta_per_g"]',
        'ft_pct_yoy': 'td[data-stat="ft_pct"]',
        'orb_yoy': 'td[data-stat="orb_per_g"]',
        'drb_yoy': 'td[data-stat="drb_per_g"]',
        'trb_yoy': 'td[data-stat="trb_per_g"]',
        'ast_yoy': 'td[data-stat="ast_per_g"]',
        'stl_yoy': 'td[data-stat="stl_per_g"]',
        'blk_yoy': 'td[data-stat="blk_per_g"]',
        'tov_yoy': 'td[data-stat="tov_per_g"]',
        'pf_yoy': 'td[data-stat="pf_per_g"]',
        'pts_yoy': 'td[data-stat="pts_per_g"]',
    }
...
df.to_csv('per_game_yoy.csv', index=False)
